...
<body>
	...
	<div class="alert alert-danger d-flex alert-dismissible fade show alert-file" role="alert">
        <svg class="bi flex-shrink-0 me-2" width="24" height="24"><use xlink:href="#exclamation-triangle-fill"/></svg>
		При добавлении файла ... возникли ошибки!
		<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Закрыть"></button>
	</div> -->

    <div class="container wrap main">

        <form method="post" action="{{ route('reports.store') }}" enctype="multipart/form-data" class="col-lg-6 offset-lg-3">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control" id="nameFile" placeholder="Имя файла" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-file">
                    <input type="file" class="form-file-input" id="formControlFile" name="report" required>
